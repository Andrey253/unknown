      ...
      children: [
        TableRow(children: [
          ...
          const Padding(
            ...
            child: Text('Вылет из', style: HotelTheme.textStyle16_400Grey,maxLines: 10),
          ),
          Text(roomModel.departure, style: HotelTheme.textStyle16_400Black,maxLines: 10)
        ]),
        TableRow(children: [
          //two
          const Padding(
            padding: EdgeInsets.symmetric(vertical: 8.0),
            child: Text('Страна, Город', style: HotelTheme.textStyle16_400Grey,maxLines: 10),
          ),
          Text(roomModel.arrivalCountry, style: HotelTheme.textStyle16_400Grey,maxLines: 10)
        ]),
        TableRow(children: [
          //three
          const Padding(
            padding: EdgeInsets.symmetric(vertical: 8.0),
            child: Text('Даты', style: HotelTheme.textStyle16_400Grey,maxLines: 10),
          ),
        ...
        TableRow(children: [
          ...
          const Padding(
            padding: EdgeInsets.symmetric(vertical: 8.0),
            child: Text('Кол-во ночей', style: HotelTheme.textStyle16_400Grey,maxLines: 10),
          ),
        ...
        TableRow(children: [
          ...
          Text(roomModel.room, style: HotelTheme.textStyle16_400Grey,maxLines: 10)
        ]),
        TableRow(children: [
          //seven
          const Padding(
          ...
          Text(roomModel.nutrition, style: HotelTheme.textStyle16_400Grey,maxLines: 10)
        ]),
      ],
    ));
  }
